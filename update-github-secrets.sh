...
gh secret set TF_VAR_AWS-ACCOUNT-ID -b"$AWS_ACCOUNT_ID"
export TF_VAR_AWS-ACCOUNT-ID="$AWS_ACCOUNT_ID"
gh secret set TF_VAR_AWS-REGION -b"$AWS_REGION"
export TF_VAR_AWS-REGION="$AWS_REGION"
